...
public class BlockManager
{
	...
	private static Semaphore printMutex = new Semaphore(1);
	...
	public static void main(String[] argv)
	{
		try
		{
			...
			System.out.println(-BaseThread.getThreadAmount());
